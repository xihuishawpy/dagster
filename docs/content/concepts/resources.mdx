...
When defining asset jobs (using <PyObject object="define_asset_job" />), you don't need to providing resources to the job directly. The job will make use of the resources provided to the assets.
